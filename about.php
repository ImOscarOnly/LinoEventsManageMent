...
<?php include('includes/head.php') ?>	
    <?php include('includes/navigation.php') ?>
		...
		<div class="container text-center">
			<h1>About Us<span class="m_1">Lino P. Bernardo National High School</span></h1>
		</div>
	</div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4>LPBNHS BRIEF BACKGROUND</h4>
                        <h2>POWER THRU KNOWLEDGE</h2>
                        <p>SCHOOL BACKGROUND INTRO GOES HERE</p>

                        <p> SCHOOL BACKGROUND CONTENT GOES HERE</p>
				...
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="images/slider-01.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
			</div>
			<div class="row align-items-center">
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="post-media wow fadeIn">
                        <img src="images/slider-02.jpg" alt="" class="img-fluid img-rounded">
                    </div><!-- end media -->
                </div><!-- end col -->
				
				<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h2>happening on last years</h2>
                        <p>intro goes here</p>
